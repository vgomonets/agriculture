class ContractorProfileUserTabHistoryClass {
    ...
    constructor() {
        ...
        this.config = {
            tableElement: '#contractorProfileUserTabHistoryTable',
            listAjaxUrl: '/contractor/profile/history/user/' + $('input[name=item_id]').val() + '/',
            bootstrapTable: {
                columns: [
...
$(document).ready(function() {
    window.contractorProfileUserTabHistory = new ContractorProfileUserTabHistoryClass();
});
