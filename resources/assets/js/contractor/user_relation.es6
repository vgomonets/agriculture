class contractorIndexClass {
    ...
    constructor() {
        ...
        this.config = {
            ...
            listAjaxUrl: '/contractor/relation/user/list/' + $('input[name=item_id]').val() + '/',
            createAjaxUrl: '/contractor/relation/user/create',
            deleteAjaxUrl: '/contractor/relation/user/delete',
