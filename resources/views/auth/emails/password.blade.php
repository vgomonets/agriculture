        ...
        <table class="" cellpadding="0" cellspacing="0" style="width:100%;font-size:0px;background:#d8e2e7;"
            ...
            <tr>
                <td style="text-align:center;vertical-align:top;font-size:0;padding:1px;"><!--[if mso]>
                    ...
                    <![endif]-->
                    <div style="margin:0 auto;width:100%;background:#00b2b2;">
                            ...
                            <tr>
                                <td style="font-size:0;padding:0 30px 16px;" align="left">
                                    <div class="mj-content"
                                        ...
                                        <div>&nbsp;</div>
                                        Для восстановления пароля воспользуйтесь кнопкой входа: <br />
                                    </div>
                                    <div class="mj-content" style="cursor:auto;color:#000000;font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:15px;line-height:22px;">
                                        <p><a href="{{$link = url('password/reset', $token).'?email='.urlencode($user->getEmailForPasswordReset())}}" ><img src="http://i.dsecurity.org/img/button.png" width="108" height="38" /></a></p>
                                    </div>
                                    <div class="mj-content" style="cursor:auto;color:#888888;font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:12px;line-height:12px;">Если не удается войти на сайт - перейдите по ссылке: <br />                                             
                                        <a href="{{ $link }}" style="color:#888888;"> {{ $link }} </a>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
                            ...
                            <tr>
                                <td style="font-size:0;padding:0px;" align="center">
                                    <div class="mj-content"
                                        ...
                                        <a href="http://i.dsecurity.org/"
                                           style="text-decoration: none; color: inherit;">
                                            <span style="border-bottom: solid 1px #b3bac1">Dream Security</span>
                                        </a>
                                        | Все права защищены
                                    </div>
                                </td>
